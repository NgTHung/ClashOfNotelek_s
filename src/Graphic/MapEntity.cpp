...
#include "Utility/Enviroment.hpp"
 ...
 Tree::Tree(Engine& g_Engine,const sf::Vector2f& size):GraphicBase(size),m_SpriteTree(ResourcesManager::GetManager().GetTextureHolder().GetTexture("Tree.png")), m_Engine(g_Engine)
{
...
bool Tree::FixLagUpdate(const sf::Time& DT)
 {
  return true;
 }
...
Grass::Grass(Engine& g_Engine,const sf::Vector2f& size):GraphicBase(size),m_Sprite(ResourcesManager::GetManager().GetTextureHolder().GetTexture("grass.png")), m_Engine(g_Engine)
 {
...
bool Grass::FixLagUpdate(const sf::Time& DT)
 {
  return true;
 }
...
TinyGrass::TinyGrass(Engine& g_Engine,const sf::Vector2f& size):GraphicBase(size),m_Sprite(ResourcesManager::GetManager().GetTextureHolder().GetTexture("TinyGrass.png")), m_Engine(g_Engine)
 {
...
bool TinyGrass::FixLagUpdate(const sf::Time& DT)
 {
  return true;
 }
...
//==========================================================================
Box::Box(Engine& g_Engine,const sf::Vector2f& size):GraphicBase(size),m_Sprite(ResourcesManager::GetManager().GetTextureHolder().GetTexture("Box.png")), m_Engine(g_Engine)
 {
...
bool Box::FixLagUpdate(const sf::Time& DT)
 {
  return true;
 }
