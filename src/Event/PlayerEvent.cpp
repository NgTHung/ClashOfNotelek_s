...
GlobalEventType PlayerMovedEvent::GetEventType() const
{
    return GlobalEventType::PlayerMoved;
}

PlayerStopMoved::PlayerStopMoved(Player &Player, const Direction &OldDirection) : m_OldDirection(OldDirection), m_Player(Player) {};
GlobalEventType PlayerStopMoved::GetEventType() const
{
